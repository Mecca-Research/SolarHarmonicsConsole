...
- Rendering: Inner planets (Mercury, Venus, Mars) use a custom terminator ShaderMaterial (sun-facing day side, near-dark night side, same soft terminator as Earth); outer planets (Jupiter, Saturn, Uranus, Neptune, Pluto) use MeshBasicMaterial for 360° full illumination
